...
-- Description --
This program allows the user to search a dataset of 400 websites that contain content about PlayStation 2 video games. It features a multiple different search engines to demonstrate the effect and usefulness of different information retrieval techniques and processes. By using TF-IDF ranking and Cosine similarity, the program produces a result set at ten precision for all queries across all 7 search engines.
...
-- Installation --
To use this program, the user will have to have installed the nltk, NumPy, spacy, regex, os, time, pandas and beautifulsoup. Following this, the user will also need the following datasets downloaded from nltk: 'stopwords', 'wordnet' and 'punkt'.
